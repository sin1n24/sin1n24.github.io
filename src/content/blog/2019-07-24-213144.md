...
ネットでPIC24Fを使ってSBUSを読んでる人は見つけられなかったので、M5Stackで使った[Arduino](http://d.hatena.ne.jp/keyword/Arduino)用のコードを参考に移植しましたが、多少ハマった所もあったので、参考までに末尾に[ソースコード](http://d.hatena.ne.jp/keyword/%A5%BD%A1%BC%A5%B9%A5%B3%A1%BC%A5%C9)載せておきます
...
<tr>
<td><a class="keyword" href="http://d.hatena.ne.jp/keyword/2ch">2ch</a></td>
<td>左スティック上下</td>
<td>左脚スロットル</td>
</tr>
<tr>
...
個人的には緊急停止スイッチの位置は共[通化](http://d.hatena.ne.jp/keyword/%C4%CC%B2%BD)したら良さそうかなと思いますが、取敢えずはプロポ側で目立つようにしとくべきですね
